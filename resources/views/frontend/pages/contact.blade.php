...
@section('main-content')
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>Hubungi kami</h4>
									<h3>Tinggalkan pesan pada kami @auth @else<span style="font-size:12px;" class="text-danger">[Kamu harus login terlebih dahulu]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="subject" type="text" id="subject" placeholder="Masukkan judul">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
	...
	<div class="map-section">
		<div id="myMap">
			<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15862.140621657123!2d107.169155!3d-6.324617!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e699b0c08ad8d01%3A0x2b18001d1b1371f9!2sUNIVERSITAS%20PELITA%20BANGSA!5e0!3m2!1sid!2sid!4v1717940124036!5m2!1sid!2sid" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
	</div>
	<!--/ End Map Section -->
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-success">Pesan kamu berhasil dikirim...</p>
			</div>
		  </div>
		</div>
	</div>
