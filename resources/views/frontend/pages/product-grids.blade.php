                                    ...
                                    <div class="single-widget range">
                                        ...
                                        <div class="price-filter">
                                            <div class="price-filter-inner">
                                                ...
                                                <button type="submit" class="filter_button">Saring</button>
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                @endphp
                                                <p class="price">Rp{{number_format($org,2)}}  </p>
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        ...
                                                        <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Tambahkan ke favorit</span></a>
                                                    </div>
                                        ...
                                        <div class="quickview-content">
                                            ...
                                            <div class="quickview-ratting-review">
                                                ...
                                                <div class="quickview-stock">
                                                    ...
                                                    @else
                                                    <span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} stok tersisa</span>
                                                    @endif
                                                </div>
                                            </div>
                                            @php
